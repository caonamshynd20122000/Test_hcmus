...
C {sky130_fd_pr/cap_mim_m3_1.sym} -10 -60 1 0 {name=C1 model=cap_mim_m3_1 W=9 L=9 MF=2 spiceprefix=X}
...
C {devices/vsource.sym} -620 30 0 0 {name=I1 value=63.26u savecurrent=false}
